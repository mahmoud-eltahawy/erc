...
async fn insert_employees(app_state : &AppState) -> Result<(),Box<dyn Error>> {
  ...
  let employee1 = Employee{id : Uuid::new_v4(),card_id : 1,department_id  : kilens_id,
        first_name : "احمد".to_string(),middle_name: "جمال".to_string(),last_name : "محمد".to_string(),
                          password : "1234".to_string(),position : "USER".to_string()};

  let employee2 = Employee{department_id : drayers_id,..employee1.clone()};
  let employee3 = Employee{department_id : incjet_id,..employee1.clone()};
  ...
  let employees : Vec<Employee<Uuid>> = vec![
    ...
    Employee{id : id4 ,card_id : 4,first_name  : "صلاح".to_string(),..employee1.clone()},
    Employee{id : id5 ,card_id : 5,first_name  : "جابر".to_string(),..employee1.clone()},

    Employee{id : id6 ,card_id : 6,first_name  : "جلال".to_string(),..employee2.clone()},
    Employee{id : id7 ,card_id : 7,first_name  : "يوسف".to_string(),..employee2.clone()},
    Employee{id : id8 ,card_id : 8,first_name  : "هلال".to_string(),..employee2.clone()},
    Employee{id : id9 ,card_id : 9,first_name  : "ابراهيم".to_string(),..employee2.clone()},
    Employee{id : id10,card_id : 10,first_name : "منتصر".to_string(),..employee2.clone()},

    Employee{id : id11,card_id : 11,first_name : "عمر".to_string(),..employee3.clone()},
    Employee{id : id12,card_id : 12,first_name : "حكيم".to_string(),..employee3.clone()},
    Employee{id : id13,card_id : 13,first_name : "طه".to_string(),..employee3.clone()},
    Employee{id : id14,card_id : 14,first_name : "علاء".to_string(),..employee3.clone()},
    Employee{id : id15,card_id : 15,first_name : "مصطفي".to_string(),..employee3.clone()},

    Employee{id : id16,card_id : 16,first_name : "معتز".to_string(),..employee4.clone()},
    Employee{id : id17,card_id : 17,first_name : "سيد".to_string(),..employee4.clone()},
    Employee{id : id18,card_id : 18,first_name : "اسماعيل".to_string(),..employee4.clone()},
    Employee{id : id19,card_id : 19,first_name : "جمعة".to_string(),..employee4.clone()},
    Employee{id : id20,card_id : 20,first_name : "اشرف".to_string(),..employee4.clone()},

    Employee{id : id21,card_id : 21,first_name : "طارق".to_string(),..employee5.clone()},
    Employee{id : id22,card_id : 22,first_name : "يحي".to_string(),..employee5.clone()},
    Employee{id : id23,card_id : 23,first_name : "مهدي".to_string(),..employee5.clone()},
    Employee{id : id24,card_id : 24,first_name : "شعبان".to_string(),..employee5.clone()},
    Employee{id : id25,card_id : 25,first_name : "عباس".to_string(),..employee5.clone()},
  ];
